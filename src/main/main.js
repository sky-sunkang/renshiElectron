...
app.whenReady().then(() => {
  ...
  ipcMain.handle('perm:addUserRole', (_, userId, roleId) => db.addUserRole(userId, roleId))
  ipcMain.handle('perm:removeUserRole', (_, userId, roleId) => db.removeUserRole(userId, roleId))
